...
final class InventoryCountCancellationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new InventoryService(
            ...
            new CountCancellationFixedClock(
    ...
    public function testCancellationCannotCrossHomeBoundary(): void
    {
        try {
            ...
            self::fail(
                'A count session was cancelled through another home.',
            );
    ...
    public function testCountLineCreationUpdateAndStaleRevisionAreCompareAndSwapSafe(): void
    {
        ...
        try {
            ...
            self::fail(
                'A stale stock-count line revision was accepted.',
            );
        } catch (Problem $problem) {
    ...
    private function schema(): array
    {
        return [
            ...
            ('CREATE TABLE stock_count_sessions (
                id TEXT PRIMARY KEY,'
                . ' home_id TEXT NOT NULL, location_id TEXT NULL,
                status '
                . 'TEXT NOT NULL, notes TEXT NOT NULL, scope_complete INTEGER NOT NULL,'
                . '
                reliability TEXT NOT NULL, revision INTEGER NOT NULL,'
                . '
                opened_by_user_id TEXT NOT NULL, opened_at TEXT NOT '
                . 'NULL,
            ...
            ('CREATE TABLE home_products (
                id TEXT PRIMARY KEY, '
                . 'home_id TEXT NOT NULL, product_id TEXT NULL,
                pack_id '
                . 'TEXT NULL, private_name TEXT NULL, original_pack_text TEXT NULL,'
                . '
            ...
            ('CREATE TABLE stock_count_lines (
                id TEXT PRIMARY KEY, '
                . 'home_id TEXT NOT NULL, session_id TEXT NOT NULL,
                '
                ...
                . '
                counted_by_user_id TEXT NOT NULL, created_at TEXT NOT '
                . 'NULL,
            ...
            ('CREATE TABLE change_log (
                sequence_id INTEGER PRIMARY '
                . 'KEY AUTOINCREMENT, home_id TEXT NOT NULL,
                entity_type '
                . 'TEXT NOT NULL, entity_id TEXT NOT NULL,
                operation_type '
                . 'TEXT NOT NULL, revision INTEGER NOT NULL,
                '
                . 'payload_schema_version INTEGER NOT NULL, payload_json TEXT NOT NULL,'
                . '
                changed_by_user_id TEXT NOT NULL, changed_at TEXT NOT '
                . 'NULL
            )'),
            ('CREATE TABLE outbox_messages (
                id TEXT PRIMARY KEY, '
                . 'message_type TEXT NOT NULL, queue_name TEXT NOT NULL,
                '
                . 'payload TEXT NOT NULL, occurred_at TEXT NOT NULL, available_at TEXT NOT '
                . 'NULL,
                published_at TEXT NULL, attempts INTEGER NOT NULL,'
