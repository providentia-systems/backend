...
final class OperatorWorkspaceHandler implements RequestHandlerInterface
{
    public function __construct(
        private readonly OperatorWorkspaceService $workspace,
    ...
    public function handle(
        ...
        if ($this->action === 'review-administrator') {
            $this->workspace->reviewAdministrator(
                $identity,
        ...
        return new JsonResponse(
            match ($this->action) {
                ...
                'administrators' => [
                    'data' => $this->workspace->administrators($identity),
                ],
                'audit' => [
                    'data' => $this->workspace->audit($identity, $offset),
                ],
