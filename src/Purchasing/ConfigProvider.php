        ...
        return [
            'dependencies' => [
                ...
                'factories' => [
                    ...
                    'purchasing.stores.update' => PurchasingFactory::class,
                    'purchasing.stores.list' => PurchasingFactory::class,
                    'purchasing.create' => PurchasingFactory::class,
                    'purchasing.update' => PurchasingFactory::class,
                    'purchasing.cancel' => PurchasingFactory::class,
                    'purchasing.lines.update' => PurchasingFactory::class,
                    'purchasing.lines.remove' => PurchasingFactory::class,
