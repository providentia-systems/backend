...
final class FeatureCatalog
{
    ...
    public static function defaults(): array
    {
        ...
        return [
            self::group(
                self::STARTER_ACCOUNT,
                self::ACCOUNT,
                'Starter account',
                ['homes.create' => true, 'homes.join' => true],
                ['homes.owned' => 1, 'homes.joined' => -1],
            ),
            self::group(
                self::INVITED_ACCOUNT,
                self::ACCOUNT,
                'Invited account',
                ['homes.create' => false, 'homes.join' => true],
                ['homes.owned' => 0, 'homes.joined' => -1],
            ),
            self::group(
                self::STARTER_HOME,
                self::HOME,
            ...
            self::group(
                ...
                self::ADMIN,
                'System owner',
                array_fill_keys(self::features(self::ADMIN), true),
                [],
                true,
            ),
        ];
    ...
    private static function group(
        ...
        return [
            ...
            'features' => $features,
            'limits' => $limits,
            'delegablePermissions' => $scope === self::HOME
