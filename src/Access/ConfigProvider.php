...
final class ConfigProvider
{
    ...
    public function __invoke(): array
    {
        return ['dependencies' => [
            'aliases' => [
                \Providentia\Identity\Application\ProfileMediaStore::class => \Providentia\Identity\Infrastructure\Doctrine\DbalProfileMediaStore::class,
                \Providentia\Administration\Application\OperatorWorkspaceStore::class => \Providentia\Administration\Infrastructure\Doctrine\DbalOperatorWorkspaceStore::class,
                \Providentia\Access\Application\AccessStore::class => \Providentia\Access\Infrastructure\Doctrine\DbalAccessStore::class,
                \Providentia\Identity\Application\AccountProfileStore::class => \Providentia\Identity\Infrastructure\Doctrine\DbalAccountProfileStore::class,
                \Providentia\Identity\Application\EmailCodeStore::class => \Providentia\Identity\Infrastructure\Doctrine\DbalEmailCodeStore::class,
                \Providentia\Geography\Application\CountryStore::class => \Providentia\Geography\Infrastructure\Doctrine\DbalCountryStore::class,
            ],
            'factories' => [
                \Providentia\Administration\Application\OperatorWorkspaceService::class => AccessFactory::class,
                \Providentia\Administration\Infrastructure\Doctrine\DbalOperatorWorkspaceStore::class => AccessFactory::class,
                \Providentia\Identity\Application\ProfileMediaService::class => AccessFactory::class,
                \Providentia\Identity\Infrastructure\Doctrine\DbalProfileMediaStore::class => AccessFactory::class,
                \Providentia\Identity\Infrastructure\Cli\SystemOwnerCommand::class => AccessFactory::class,
                \Providentia\Geography\Infrastructure\Cli\ReferenceUpdateCommand::class => AccessFactory::class,
                ...
                \Providentia\Access\Infrastructure\Doctrine\DbalAccessStore::class => AccessFactory::class,
                \Providentia\Identity\Infrastructure\Doctrine\DbalAccountProfileStore::class => AccessFactory::class,
                \Providentia\Identity\Infrastructure\Doctrine\DbalEmailCodeStore::class => AccessFactory::class,
                \Providentia\Geography\Infrastructure\Doctrine\DbalCountryStore::class => AccessFactory::class,
                ...
                \Providentia\Identity\Application\AccountProfileService::class => AccessFactory::class,
            ...
            'reference:update' => \Providentia\Geography\Infrastructure\Cli\ReferenceUpdateCommand::class,
        ]]];
    }
}
