    ...
    public function verify(
        ...
        if ($challenge === null) {
            throw new Problem(
                422,
                'Invalid code',
                'The code is incorrect, expired, already used, or has exhausted its attempts.',
            );
        }
        $challenge['context'] = json_decode(
            (string) $challenge['context_json'],
            true,
            32,
            JSON_THROW_ON_ERROR,
        );
