...
return static function (Application $app): void {
    $app->get(
        ...
        [
            ...
            'operator-workspace.homes',
        ],
        'api.operator-workspace.homes.0',
    );
    $app->get(
        '/api/v1/admin/homes/{homeId}',
        [
            BearerAuthenticationMiddleware::class,
            'operator-workspace.home',
        ],
        'api.operator-workspace.home.1',
    );
    $app->get(
        '/api/v1/admin/homes/{homeId}/records/{collection}',
        [
            BearerAuthenticationMiddleware::class,
            'operator-workspace.records',
        ],
        'api.operator-workspace.records.2',
    );
    $app->get(
        '/api/v1/admin/administrators',
        [
            BearerAuthenticationMiddleware::class,
            'operator-workspace.administrators',
        ],
        'api.operator-workspace.administrators.3',
    );
    $app->post(
        '/api/v1/admin/administrators/{userId}/review',
        [
            BearerAuthenticationMiddleware::class,
            'operator-workspace.review-administrator',
        ],
        'api.operator-workspace.review-administrator.4',
    );
    $app->get(
        ...
        'api.operator-workspace.audit.5',
    );
    $app->get(
        '/api/v1/homes/{homeId}/profile',
        [
            BearerAuthenticationMiddleware::class,
            'profile-media.home-profile',
        ],
        'api.profile-media.home-profile.6',
    );
    $app->put(
        '/api/v1/homes/{homeId}/profile',
        [
        ...
        'api.profile-media.home-profile.7',
    );
    $app->get(
        '/api/v1/homes/{homeId}/image',
        [
            BearerAuthenticationMiddleware::class,
            'profile-media.image',
        ],
        'api.profile-media.image.8',
    );
    $app->put(
        '/api/v1/homes/{homeId}/image',
        [
    ...
    $app->delete(
        ...
        'api.profile-media.image.14',
    );
    $app->post(
        '/api/v1/me/avatar/gravatar',
        [
            BearerAuthenticationMiddleware::class,
            'profile-media.gravatar',
        ],
        'api.profile-media.gravatar.15',
    );
    $app->get(
        '/api/v1/admin/homes/{homeId}/image',
        [
            BearerAuthenticationMiddleware::class,
            'profile-media.operator-image',
        ],
        'api.profile-media.operator-image.16',
    );
    $app->get(
        ...
        'api.profile-media.operator-image.17',
    );
    $app->post(
        '/api/v1/me/home-invitations/{invitationId}/decline',
        [
            BearerAuthenticationMiddleware::class,
            'home.decline-invitation',
        ],
        'api.home-invitations.decline',
    );
    $app->get(
        '/api/v1/homes/{homeId}/memberships/{userId}/permissions',
        [
            BearerAuthenticationMiddleware::class,
            'home.member-permissions',
        ],
        'api.home-memberships.permissions',
    );
    $app->put(
        '/api/v1/homes/{homeId}/memberships/{userId}/permissions',
        [
            BearerAuthenticationMiddleware::class,
            'home.save-member-permissions',
        ],
        'api.home-memberships.permissions.save',
    );
    $app->post(
        '/api/v1/auth/email-codes',
        'email-login.request',
        'api.email-login.request',
    );
    $app->post(
        '/api/v1/auth/email-codes/verify',
        'email-login.verify',
        'api.email-login.verify',
    );
    $app->get(
        '/api/v1/me/profile',
        [
    ...
    $app->post(
        ...
        'api.profile.email-primary',
    );
    $app->post(
        '/api/v1/me/emails/{emailId}/remove',
        [
            BearerAuthenticationMiddleware::class,
            'profile.email-remove',
        ],
        'api.profile.email-remove',
    );
    $app->post(
        '/api/v1/me/security-codes',
        [
            BearerAuthenticationMiddleware::class,
            'profile.security-request',
        ],
        'api.profile.security-request',
    );
    $app->post(
        '/api/v1/me/security-codes/verify',
        [
            BearerAuthenticationMiddleware::class,
            'profile.security-verify',
        ],
        'api.profile.security-verify',
    );
    $app->get(
    ...
    $app->get(
        '/api/v1/countries/{countryCode}/policy',
        'country.policy',
        'api.country.policy',
    );
    $app->get(
        '/api/v1/countries/{countryCode}/states',
        'country.states',
        'api.country.states',
    );
    $app->get(
    ...
    $app->get(
        ...
        'api.country.policies',
    );
    $app->post(
        '/api/v1/admin/privacy-policies',
        [
            BearerAuthenticationMiddleware::class,
            'country.policy-create',
        ],
        'api.country.policy-create',
    );
    $app->put(
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'administration.operator-accounts-list',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'administration.operator-accounts-get',
        ],
    ...
    $app->patch(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'administration.operator-accounts-status',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'home.propose-ownership-transfer',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'home.accept-ownership-transfer',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'home.reject-ownership-transfer',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'home.revoke-ownership-transfer',
        ],
        'api.home-ownership-transfers.revoke',
    );
    $app->get(
        '/api/v1/catalog/products',
        CatalogSearchHandler::class,
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.proposals.submit',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.proposals.decision',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.conflicts.keep',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.merges.preview',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.merges.apply',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.governance.merges.reverse',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.suggestions.list',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.runs.create',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.explanation.get',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.feedback.create',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.estimates.list',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.preferences.get',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.preferences.put',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.prices.list',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.backtests.create',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'shopping.intelligence.backtests.get',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contributions.consent.get',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contributions.consent.put',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contribution-images.upload',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contributions.review.list',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contributions.review.decide',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            CatalogContributionPromotionHandler::class,
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contribution-images.preview',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'catalog.contribution-images.publication',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.account.export',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.account.erasure',
        ],
    ...
    $app->get(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.account.requests',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.request.cancel',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.request.download-token',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'data-governance.request.download',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.prices.create',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.prices.status',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.provider-prices.put',
        ],
    ...
    $app->put(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.entitlements.put',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.promotions.create',
        ],
    ...
    $app->post(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.overrides.put',
        ],
    ...
    $app->delete(
        ...
        [
            BearerAuthenticationMiddleware::class,
            'billing.operator.overrides.revoke',
        ],
